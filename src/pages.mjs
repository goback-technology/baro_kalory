...
export const PAGES = [
  ...
  { id: "settings",    slug: "settings",    label: "설정",          versionKey: "settings",    badge: "SET",  spa: false, camera: false },
  { id: "calibration", slug: "calibration", label: "캘리브레이션",    versionKey: "calibration", badge: "CAL",  spa: false, camera: true },
